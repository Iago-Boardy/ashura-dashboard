...
if (isset($_POST["submit"])) {
    ...
    $stmt = $conn->prepare("INSERT INTO funcionario (nome, idTrabalho) VALUES (?, ?)");
    $stmt->bind_param("si", $nome, $trabalho);
    $result = $stmt->execute();
        ...
        <main class="main-content">
            ...
            <section class="section-1">
                ...
                <div class="form-container">
                    <form id="client-form" action="funcionarios-adicionar.php" method="POST">

                        <div class="intro-content">
                            <div class="intro-text">
                                <h1>Adicionar Funcionários</h1>
                                <p>Insira as informações necessárias para adicionar um funcionário novo:</p>
                            </div>
