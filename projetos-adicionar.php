...
if (isset($_POST["submit"])) {
    ...
    $stmt = $conn->prepare("INSERT INTO projeto (nomeProjeto) VALUES (?)");
        ...
        <main class="main-content">
            ...
            <section class="section-1">
                ...
                <div class="form-container">
                    <form id="client-form" action="projetos-adicionar.php" method="POST">

                        <div class="intro-content">
                            <div class="intro-text">
                                <h1>Adicionar Projetos</h1>
                                <p>Insira as informações necessárias para adicionar um projeto novo:</p>
                            </div>
