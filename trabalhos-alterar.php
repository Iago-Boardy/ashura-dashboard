...
if (!empty($_GET["idTrabalho"])) {
    ...
    $sqlSelect = "SELECT * FROM trabalho WHERE idTrabalho = '$id'";
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <section class="section-1">
                <a href="trabalhos.php" class="back-button"><i class="fas fa-arrow-left"></i></a>
                <div class="form-container">
                    <form id="client-form" action="saveEditTrabalhos.php" method="POST">
                        
                        <div class="intro-content">
                            <div class="intro-text">
                                <h1>Alterar Trabalhos</h1>
                                <p>Altere ou exclua os trabalhos a seguir:</p>
                            </div>

                            <div class="table-buttons">
                                <a href="deleteTrabalhos.php?id=<?php echo $id; ?>" id="submit-a" 
                                onclick="return confirm('Tem certeza de que deseja excluir este trabalho?');">
                        ...
                        <div class="form-row">
                            <div class="form-group label-full-width spacing">
                                <label for="name">Nome do trabalho</label>
