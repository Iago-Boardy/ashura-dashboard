...
if (!empty($_GET["idProjeto"])) {
    ...
    $sqlSelect = "SELECT * FROM projeto WHERE idProjeto = '$id'";
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <section class="section-1">
                <a href="projetos.php" class="back-button"><i class="fas fa-arrow-left"></i></a>
                <div class="form-container">
                    <form id="client-form" action="saveEditProjetos.php" method="POST">
                        
                        <div class="intro-content">
                            <div class="intro-text">
                                <h1>Alterar Projetos</h1>
                                <p>Altere ou exclua os projetos a seguir:</p>
                            </div>

                            <div class="table-buttons">
                                <a href="deleteProjetos.php?id=<?php echo $id; ?>" id="submit-a" 
