...
if (isset($_POST["submit"])) {
    ...
    $stmt = $conn->prepare("INSERT INTO trabalho (nomeTrabalho) VALUES (?)");
        ...
        <main class="main-content">
            ...
            <section class="section-1">
                ...
                <div class="form-container">
                    <form id="client-form" action="trabalhos-adicionar.php" method="POST">

                        <div class="intro-content">
                            <div class="intro-text">
                                <h1>Adicionar Trabalhos</h1>
                                <p>Insira as informações necessárias para adicionar um trabalho novo:</p>
                            </div>
