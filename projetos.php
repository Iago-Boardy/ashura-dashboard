...
$sql = "SELECT * FROM projeto LIMIT $inicio, $qnt_result_pg";
$result = mysqli_query($conn, $sql);

$sql_total = "SELECT COUNT(*) AS total FROM projeto";
        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="projetos.php"><i class="fas fa-project-diagram"></i> Projetos</a></li>
            ...
            <section class="section-1">
                <div class="intro-content">
                    <div class="intro-text">
                        <h1>Projetos</h1>
                        <p>Os projetos movimentam o mercado e a economia! Gerencie seus projetos aqui!</p>
                    </div>
                    ...
                    <div class="product-table">
                        <table>
                            ...
                            <?php
                                while ($row = mysqli_fetch_array($result, MYSQLI_NUM)) {
                                    ...
                                    echo '<td><a href="projetos-alterar.php?idProjeto=' . $row[0] . '" class="edit-link"><span class="status active"><i class="fas fa-edit"></i></span></a></td>';
                                    echo "</tr>";
                                }
                                mysqli_close($conn);
                            ?>
                        ...
                        <div class="footer">
                            <div class="pagination">
                                <?php
                                if ($pagina > 1) {
                                    echo '<a href="projetos.php?pagina=' . ($pagina - 1) . '" class="pagination-link">Anterior</a>';
                                }
                                ...
                                for ($i = 1; $i <= $quantidade_pg; $i++) {
                                    if ($i == $pagina) {
                                        ...
                                        echo '<a href="projetos.php?pagina=' . $i . '" class="pagination-link">' . $i . '</a>';
                                    }
                                }

                                if ($pagina < $quantidade_pg) {
                                    echo '<a href="projetos.php?pagina=' . ($pagina + 1) . '" class="pagination-link">Próxima</a>';
                                }
                                ?>
                            </div>
                            <div class="database">
